-- Curated Atlas Listing Assistant — showcase publishing (GitHub → Netlify).
--
-- Tracks publishing of a curated presentation to the dedicated showcases repo
-- (Socialeap/frontiers3d-atlas-showcases), which a single Netlify site deploys.
-- The deployed URL is written to atlas_entries.presentation_url; listings stay
-- inactive until an admin explicitly activates them.
