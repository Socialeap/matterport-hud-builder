...
const STEPS = [
  { icon: Camera, title: "Get your space captured", body: "Work with a local 3D capture provider to turn your storefront, venue, or public space into an Atlas-ready Frontiers|3D presentation." },
  { icon: CheckCircle2, title: "Publish & submit", body: "After your Frontiers|3D presentation is published, submit the live URL for Atlas verification." },
      ...
      <section className="px-4 pt-28 pb-12 sm:pt-36 sm:pb-16">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-xs text-white/40">
            ...
            verification rolls out, you’ll publish your Frontiers|3D presentation and submit its live URL — your
      ...
      <section className="px-4 py-12">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-center text-sm leading-relaxed text-white/55">
            Publish and submit your Atlas-ready presentation. After your Frontiers|3D presentation is published, you
      ...
      <footer className="border-t border-white/5 bg-[#070b1f] px-4 py-10">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="mt-4 flex items-center gap-1.5 text-xs text-white/40">
            ...
            © {new Date().getFullYear()} Transcendence Media · Frontiers|3D. Atlas listings appear only after a published Frontiers|3D presentation is verified.
          </p>
        </div>
      </footer>
    </div>
