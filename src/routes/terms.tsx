    ...
    <div className="min-h-screen bg-[#0b0b14] text-white">
      ...
      <main className="mx-auto max-w-3xl px-4 py-16">
        ...
        <div className="prose prose-invert mt-10 max-w-none space-y-8 text-white/80">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white">6. User-Uploaded Content &amp; Media Indemnification</h2>
            <p className="mt-3">
              The Service includes a &quot;Production Vault&quot; and related upload tools that let
              you (the MSP) ingest media — including audio tracks, images, video, icons, scripts,
              embed snippets, documents, and external links — for inclusion in presentations you
              generate and distribute to your own clients. Each time you upload or link such media,
              you must affirmatively confirm via an in-product checkbox that you own or hold a valid
              license to use that media for its intended commercial purpose.
            </p>
            <p className="mt-3">
              <strong className="text-white">You assume sole and 100% liability</strong> for any and
              all claims arising from media you upload, link, embed, or otherwise transmit through
              the Service, including but not limited to: copyright infringement, trademark
              infringement, right-of-publicity violations, DMCA takedown notices, royalty disputes,
              performance-rights claims (ASCAP, BMI, SESAC, SoundExchange, PRS, or any equivalent
              body), stock-media license violations (including watermarked or unlicensed Getty,
              Shutterstock, Adobe Stock, or similar imagery), and any related damages, fines,
              settlements, or attorneys&apos; fees.
            </p>
            <p className="mt-3">
              You agree to <strong className="text-white">defend, indemnify, and hold harmless</strong>{" "}
              Transcendence Media, its officers, directors, employees, contractors, partners,
              affiliates, end-clients receiving generated HTML deliverables, and downstream viewers
              of those deliverables, from and against any and all such claims, regardless of whether
              the infringement is alleged, threatened, or proven, and regardless of whether the
              media remains hosted on Service infrastructure, has been embedded in an exported HTML
              deliverable, or has been further redistributed by your clients.
            </p>
            <p className="mt-3">
              Transcendence Media does not pre-screen, license-clear, or audit user-uploaded media.
              We reserve the right (but assume no obligation) to remove any uploaded media at any
              time, suspend Vault uploads, or terminate accounts upon receipt of a credible
              infringement notice, without liability to you. Your in-product checkbox confirmation,
              together with these Terms, constitutes a binding representation that you have the
              necessary rights, and is admissible as evidence in any subsequent dispute.
            </p>
            <p className="mt-3">
              Counter-notices and DMCA inquiries should be sent to{" "}
              <a
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white">8. Third-Party Content</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white">9. AI Features Disclaimer</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white">11. Disclaimers &amp; Limitation of Liability</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white">12. General Indemnification</h2>
            <p className="mt-3">
              In addition to the media-specific indemnification in Section 6, you agree to indemnify,
              defend, and hold harmless Transcendence Media and its officers, employees, and agents
              from any claims, damages, or expenses (including reasonable attorneys&apos; fees)
              arising out of Your Content, your use of the Service, your breach of these Terms, or
